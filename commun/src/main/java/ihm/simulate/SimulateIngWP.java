...
public class SimulateIngWP {
    ...
    public SimulateIngWP(SimulateDroit.LDroit droit, List<SimulateObjet> objets, String title, SimulateWS parentWS) {
        this.droit = droit;
        this.objects = objets;
        this.title = title;
    ...
    public boolean equals(Object o) {
        ...
        SimulateIngWP that = (SimulateIngWP) o;
