...
insert into WorkPackage(WORKPACKAGE_TITLE,WORKPACKAGE_STARTDATE,WORKPACKAGE_ENDDATE,WORKPACKAGE_DROIT,ORGANISATION_ID,VERSION_ID,WORKSPACE_ID) values ('wp1','2013-01-01 00:00:00','2013-01-11 00:00:00',1,1,1,1)
insert into WorkPackage(WORKPACKAGE_TITLE,WORKPACKAGE_STARTDATE,WORKPACKAGE_ENDDATE,WORKPACKAGE_DROIT,ORGANISATION_ID,VERSION_ID,WORKSPACE_ID) values ('wp2','2013-01-02 00:00:00','2013-01-12 00:00:00',1,1,2,1)
insert into WorkPackage(WORKPACKAGE_TITLE,WORKPACKAGE_STARTDATE,WORKPACKAGE_ENDDATE,WORKPACKAGE_DROIT,ORGANISATION_ID,VERSION_ID,WORKSPACE_ID) values ('wp3','2013-01-03 00:00:00','2013-01-13 00:00:00',2,2,1,2)
